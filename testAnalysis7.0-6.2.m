...
for n = 4:10
   ...
   pH7_00CI(n) = ShiftA_CI(2)-mean(ShiftA);
   pH7_00(n) = mean(ShiftA);


   pH6_80CI(n) = ShiftB_CI(2)-mean(ShiftB);
   pH6_80(n) = mean(ShiftB);

   pH6_60CI(n) = ShiftC_CI(2)-mean(ShiftC);
   pH6_60(n) = mean(ShiftC);

   pH6_40CI(n) = ShiftD_CI(2)-mean(ShiftD);
   pH6_40(n) = mean(ShiftD);
...
pHlist = [pH7_00; pH6_80; pH6_60; pH6_40; pH6_20];
pHCIlist = [pH7_00CI; pH6_80CI; pH6_60CI; pH6_40CI;pH6_20CI];

%Diff = pH4_01-pH7_00;
temp = cat(1,pH7_00-Ref,pH6_80-Ref,pH6_60-Ref,pH6_40-Ref,pH6_20-Ref ,Ref,pH7_00CI,pH6_80CI,pH6_60CI,pH6_40CI,pH6_20CI,RefCI);
Test = array2table(temp, 'RowNames',{'7pH','6.8pH','6.6pH','6.4pH','6.2pH','Ref', '7pH err','6.8pH err','6.6pH err','6.4pH err','6.2pH err','Ref err'} ,'VariableNames',{'1MHz','2MHz','3MHz','4MHz','5MHz','6MHz','7MHz','8MHz','9MHz','10Mhz'})
